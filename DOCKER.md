...
The first run is slow because Docker builds the app image, Ollama downloads `qwen3:4b`,
and faster-whisper downloads the Whisper model on first transcription.
